...
class Settings(BaseSettings):
    ...
    # Old static paths removed, replaced by properties and private fields
    ...
    def people_model_path(self) -> str:
        ...
        return self._people_model_path
    ...
    def gender_model_path(self) -> str:
        ...
        return self._gender_model_path
    ...
    def fire_model_path(self) -> str:
        ...
        return self._fire_model_path

    # Private fields for PyTorch paths (loaded from env)
    _people_model_path: str = Field(alias="PEOPLE_MODEL_PATH", default="models/people.pt")
    _gender_model_path: str = Field(alias="GENDER_MODEL_PATH", default="models/gender.pt")
    _fire_model_path: str = Field(alias="FIRE_MODEL_PATH", default="models/fire.pt")
    ...
    max_read_retries_per_camera: int = 50   # Max retries before giving up (~1 hour)
