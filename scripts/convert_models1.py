...
def convert_to_onnx(model_path: str, output_path: str = None, dynamic: bool = False):
    """
    ...
    Args:
        ...
        dynamic: Whether to export with dynamic shapes
    """
    try:
        ...
        model.export(
            format='onnx',
            imgsz=640,
            dynamic=dynamic,  # Fixed shapes by default for better performance
...
def convert_yolo_to_openvino_direct(model_path: str, output_dir: str = None, half: bool = False, dynamic: bool = False):
    """
    ...
    Args:
        ...
        dynamic: Export with dynamic shapes
    """
    try:
        from ultralytics import YOLO
        ...
        model.export(
            ...
            dynamic=dynamic  # Fixed shapes by default
        )
