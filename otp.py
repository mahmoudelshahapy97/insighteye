...
async def verify_otp(request: OTPVerification): # Changed name from verify_otp_endpoint
    ...
    try:
        # OTPManager.verify_otp is called with positional args for email and otp.
        # `purpose` will default to 'login' in OTPManager.verify_otp. This is consistent.
...
async def delete_otp(request: OTPDeletion): # Changed name from delete_otp_endpoint
    ...
    try:
        # OTPManager.delete_otp is called with positional arg for email.
        # `purpose` will default to 'login' in OTPManager.delete_otp. This is consistent.
