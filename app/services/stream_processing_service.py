...
class StreamProcessingService:
    ...
    #         if should_notify:
    #             # Send notification
    #             message = f"FIRE/SMOKE ALERT: {fire_status.upper()} detected!"
    ...
    #                     formatted_notification
    #                 )
    #                 logger.warning(f"🔥 Broadcasted fire alert to user {owner_id}")
                
    #             # ✅ FIX: Properly fetch user email
    #             try:
    #                 user_info = await user_manager.get_user_by_id(owner_id)
    #                 if user_info and 'email' in user_info:

    #                     user_email = user_info["email"]
    #                     logger.info(f"📧 Sending fire alert email to {user_email} for camera {camera_name}")

    #                     # ✅ FIX: Get location info from stream
    #                     stream_info = await self.video_stream_service.get_video_stream_by_id(stream_id)
    #                     location_info = None
    #                     if stream_info:
    #                         location_info = {
    ...
    #             # ✅ CRITICAL: Broadcast POPUP-STYLE notification to WebSocket clients
    #             if notification and self.stream_manager:
    #                 formatted_notification = {
    #                     "type": "fire_alert_popup",  # Special type for popup
    #                     "alert": {
    #                         "id": str(notification.get("notification_id")),
    #                         "severity": "critical",
    #                         "alert_type": alert_type.lower(),  # "fire" or "smoke"
    #                         "status": fire_status,
    #                         "camera_name": camera_name,
    ...
    #                         "sound_alert": True,  # Trigger sound on frontend
    #                         "auto_dismiss_seconds": 30  # Optional: auto-dismiss after 30s
    #                     }
    #                 }
    ...
    #                     formatted_notification
    #                 )
    #                 logger.warning(f"🔥 Broadcasted FIRE POPUP alert to user {owner_id}")
                    
    #                 # Also broadcast to all workspace members for critical alerts
    #                 try:
    ...
    #                         if member_id != str(owner_id):  # Don't send twice to owner
    #                             await self.stream_manager.broadcast_notification(
    #                                 member_id,
    #                                 formatted_notification
    #                             )
                        
    #                     logger.warning(f"🔥 Broadcasted fire alert to {len(workspace_members)} workspace members")
    ...
    #             logger.warning(f"🔥 Fire POPUP alert sent for stream {stream_id_str}: {fire_status} at {location_text}")
    ...
    #             if notification and self.stream_manager:
    #                 formatted_notification = {
    #                     "type": "fire_alert_popup",  # Special type for popup - CRITICAL!
    #                     "alert": {
    #                         "id": str(notification.get("notification_id")),
    #                         "severity": "critical",
    #                         "alert_type": alert_type.lower(),  # "fire" or "smoke"
