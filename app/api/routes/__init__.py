...
from app.api.routes import auth_router, camera_router, otp_router, \
    ...
    session_router, stream_router, async_stream_router, \
    text_chat_router, user_router, workspace_router, analytics_router, \
    analytics_qdrant_router, analytics_extended_router, monitoring_router, celery_health
