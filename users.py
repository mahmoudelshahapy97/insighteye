...
# user.py
from fastapi import APIRouter, HTTPException, status, Depends, Query, Body, Path
from pydantic import BaseModel, EmailStr, Field # Import necessary Pydantic types
from typing import List, Optional
from user_manager import UserManager
# Assuming schemas_models defines these, otherwise define them here or adjust imports
from schemas_models import CreateUserRequest, VerifyPasswordRequest, ResetPasswordRequest, EmailRequest, UserRequest 

import logging
from datetime import datetime # Needed for response models potentially
...
user_manager = UserManager()  # This will create/recreate the table
