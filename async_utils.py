...
# --- Prediction Utilities (CPU-bound, remain synchronous) ---
# XGBoost models and pandas operations are CPU-bound.
# If these become very long-running, consider running them in a ProcessPoolExecutor
# or optimizing the operations themselves. For typical FastAPI usage,
# short-to-medium duration CPU tasks can be sync if not overly frequent.
